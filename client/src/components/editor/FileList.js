...
import { getDatabases, changeName, createDatabase, 
    deleteDatabase, uploadDatabase } from '../../actions/editor';
import './FileList.css';
...
const FileList = (props) => {
    ...
    const listDatabases = databases.map(db => {
        ...
        return (
            <button key={db._id} id={db._id} 
            className={className} onClick={handleFileClick}>
                {fileName}
            </button>
        )
    })
    ...
    return (
        <div className="file-div">
            ...
            className="file-upload-input" ref={inputFile}></input>
            ...
            <div className="file-footer"> 
                ...
                onClick={handleDeleteClick}>Delete a database</button>
                <button className="add-db-btn" onClick={handleFileNameClick}>{btnText}</button>
            </div>
        </div>
    )
}
