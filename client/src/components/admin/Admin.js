...
const Admin = (props) => {
    ...
    useEffect(() => {
        const fetchUsers = () => axios.get('/api/user').then(res => {
            ...
            <div className="buttons">
                ...
                <div className="select-param">
                    <Menu compact className="select-param">
                        <Dropdown value={state.searchParam} options={searchParams}
                        simple item onChange={(e, data) => dispatch({
                            type: 'searchParam',
                            value: data.value,
                        })}></Dropdown>
                    </Menu>
                </div>
                <input className="search" placeholder="Enter a value"
                value={state.search} onChange={(e) => dispatch({
                    type: 'search',
